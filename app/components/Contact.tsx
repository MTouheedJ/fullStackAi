...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      ref={ref}
      className="relative py-24 sm:py-32 md:py-40 px-6 sm:px-8 lg:px-12 bg-[#1e293b]"
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl sm:text-2xl text-[#cbd5e1] max-w-3xl mx-auto leading-relaxed">
            Ready to build intelligent AI solutions? Let\'s connect and discuss
            your next project.
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="space-y-6 mb-10">
              {/* Email Card */}
              <motion.div
                className="flex items-center gap-6 p-6 bg-[#0f172a] border border-[#334155] rounded-xl group hover:border-[#3b82f6] transition-all duration-300"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-lg text-[#f1f5f9] font-semibold">
                    Available on Upwork
                  </p>
                </div>
              </motion.div>
            ...
            >
              <p className="text-lg text-[#cbd5e1] mb-8">
                Looking for an AI developer? Find me on Upwork
              </p>
              <motion.a
                href="https://www.upwork.com/freelancers/~013b39b26bf963cfd9"
                target="_blank"
